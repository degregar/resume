...
const Experience = () => {
  ...
  if (detailsMode === DETAILS_MODES.minimal) {
    return (
      <ExperienceWrapper>
        <p>
          He was working on his own projects since 2002, since 2005 for others.
          Mostly as a programmer, but also as a hotel and marketing manager.
  ...
  return (
    <ExperienceWrapper>
      <Job project="Kukla Tech" period="07/2019 - now">
        <p>
          His own company creating web applications, websites and custom
          WordPress plugins in PHP (WordPress) and Website as a Service
          technology in Gatsby / React.
        </p>
        {detailsMode === DETAILS_MODES.full && (
          <>
            ...
            <ul>
              <li>
                Agile (Scrum) - used for 5 months working with two programmers
                at first, then one programmer, weekly sprints
              </li>
              <li>Storybook</li>
              ...
              <li>
                Tough lesson: building reusable, simple for customers to build
                and edit websites in Gatsby is reinventing the wheel with almost
                every functionality
              </li>
              <li>Designing</li>
      ...
      <Job project="mKelner" period="03/2020 - 07/2020">
        <p>
          His own startup. Web application, mobile menu for restaurants for
          pandemic, so consumers don’t have to use paper menu to read the menu.
          He's created the whole thing from scratch in Gatsby and React.
        </p>
        {detailsMode === DETAILS_MODES.full && (
          <>
            <p>Lessons learned:</p>
        ...
        {detailsMode === DETAILS_MODES.full && (
          <>
            ...
            <ul>
              ...
              <li>Redux</li>
              <li>
                Customer Discovery process, based on the book{" "}
                <i>4 steps to epiphany</i>
              </li>
              <li>Designing</li>
              <li>GDPR basics</li>
            </ul>
      ...
      <Job
        project="Jama-Tur / Hotel Jawor / Hotel Wiosna"
        period="12/2012 - 04/2018"
      >
        <p>
          Using PHP to build CRM tools, loyalty program, integrate with Property
          Management System. Managing a marketing team and a hotel staff.
        </p>
      ...
      <Job project="Authalia" period="10/2008 - 05/2010">
        <p>
          Leading dev team (programmer, designer, sysops), closely working with
          product owner and marketing specialist, to build web application that
      ...
      <Job project="Mobile Dream Studio" period="04/2007 - 07/2008">
        <p>
          Creating first microblogging platform for French company in PHP and
          Flash.
        </p>
      ...
      <Job project="Versita" period="11/2005 - 11/2006">
        <p>
          Maintaining PHP application for managing articles flow for publisher.
        </p>
...
const Job = ({ project, period, children }) => (
  <JobWrapper>
